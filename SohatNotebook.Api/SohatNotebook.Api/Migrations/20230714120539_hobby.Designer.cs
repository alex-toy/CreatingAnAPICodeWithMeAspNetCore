...
namespace SohatNotebook.Api.Migrations
{
    ...
    [Migration("20230714120539_hobby")]
    partial class hobby
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("SohatNotebook.Entities.DbSet.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("8a6a2382-9cde-4c71-a243-d9de7ef32475"),
                            AddedData = new DateTime(2023, 7, 14, 12, 5, 39, 89, DateTimeKind.Utc).AddTicks(6004),
                            Country = "france",
